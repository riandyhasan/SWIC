  ...
  return (
    ...
    >
      ...
      <Flex
        ...
        alignItems="center"
        pt={{ base: "4rem", md: "0rem" }}
      >
        <Heading color="primary.red" fontWeight={400} size="2xl">
          {props.isSubmit ? "Email has been sent!" : "Reset Password"}
        </Heading>
        <Text
          color="primary.blue"
          fontSize="0.85em"
        ...
        <Flex flexDir="column" justifyContent="center" alignItems="center">
          <Box maxW="50%">
            <Image
              src={
                props.isSubmit
                  ? "/assets/images/background/resetpasssent.png"
                  : "/assets/images/background/resetpassnotsent.png"
              }
            />
          </Box>
          <Box w="60%">
            ...
            <Flex
              justifyContent={props.isSubmit ? "center" : "flex-end"}
              mt="2rem"
            >
              {props.isSubmit ? (
                <Flex flexDir="column">
