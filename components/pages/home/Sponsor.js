...
export default function Sponsor() {
    ...
    return(
        <Flex flexDirection='column' alignItems='center' color='white' w="full" mt={mt2} mb='5em'>
            <Flex flexDirection='column' alignItems='center' p={p} pt='1.5rem' w='82%' border='2px' borderColor='rgba(255, 255, 255, 0.25)' borderRadius='2rem' bg="rgba(255,255,255,0.3)">
